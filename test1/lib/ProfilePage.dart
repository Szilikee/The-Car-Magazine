...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // Új controllerek a kapcsolatfelvételi űrlaphoz
  ...
  // Új függvény a kapcsolatfelvételi dialógus megjelenítéséhez
 void _showContactUsDialog() async {
  print("Showing Contact Us Dialog at: ${DateTime.now().toLocal()} (EEST)");
  // Előre kitöltjük a mezőket, ha a felhasználó be van jelentkezve
  if (_isLoggedIn) {
  ...
  // Új függvény a kapcsolatfelvételi üzenet elküldéséhez
 Future<void> _submitContactMessage(String userId, String username, String email, String subject, String message) async {
  try {
    ...
    // Ha a felhasználó be van jelentkezve, és nem adott meg userId-t vagy username-t, használjuk az alapértelmezett értékeket
