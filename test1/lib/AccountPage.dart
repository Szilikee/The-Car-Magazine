...
import 'package:my_car_forum/ListingDetails.dart';
...
class _CarListingEditDialogState extends State<CarListingEditDialog> {
  ...
  List<bool> _isUploadingImages = [false, false, false, false, false]; // Image upload states
  ...
  void initState() {
    ...
    selectedNumberOfDoors = widget.listing.numberOfDoors != null ? widget.listing.numberOfDoors.toString() : null;
