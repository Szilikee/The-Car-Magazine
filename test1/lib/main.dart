...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // Check if the screen width is less than a specific breakpoint (e.g., 600 for mobile)
        ...
        const DrawerHeader(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/pictures/logo.png'), // Itt add meg a képed elérési útját
              fit: BoxFit.cover, // Kép kitöltése
            ),
          ),
          child: Text(
            '',
