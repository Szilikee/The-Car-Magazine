...
namespace TheCarMagazinAPI.Controllers
{
    ...
    public class ForumController : ControllerBase
    {
        ...
        public IActionResult GetCarListings()
        {
            try
            {
                ...
                var carListingsDto = carListings.Select(car => new CarListingDto
                {
                    ...
                    Name = car.Name,
                    Year = car.Year,
                    SellingPrice = car.selling_price, // Alapértelmezett értékek kezelése ha szükséges
                    KmDriven = car.km_driven, // Alapértelmezett értékek kezelése ha szükséges
                    Fuel = car.Fuel,
        ...
        // Új autó hozzáadása az új tábla szerint
        [HttpPost("addcar")]
