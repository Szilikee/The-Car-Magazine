    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserRegistrationDto userDto)
        {
            ...
            try
            {
                ...
                var userId = await connection.ExecuteScalarAsync<long>(
                @"INSERT INTO users (username, email, password, role, VerificationCode, VerificationCodeExpiry, IsVerified, user_rank) 
                  VALUES (@Username, @Email, @Password, @Role, @VerificationCode, @VerificationCodeExpiry, @IsVerified, @UserRank); 
                  SELECT LAST_INSERT_ID();",
                    new
                    {
                        userDto.Username,
