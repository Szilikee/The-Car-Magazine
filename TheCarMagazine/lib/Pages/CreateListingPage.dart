...
class _CreateCarListingsPageState extends State<CreateCarListingsPage> {
  ...
  final List<bool> _isUploadingImages = [false, false, false, false, false]; // Képfeltöltési állapotok
  // Dropdown options
  ...
  final List<String?> _imageUrls = [null, null, null, null, null]; // Store Cloudinary URLs
