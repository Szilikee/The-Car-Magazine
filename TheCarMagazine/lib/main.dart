...
import 'package:my_car_forum/Pages/AIModelSite.dart';
import 'package:my_car_forum/Services/auth_service.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'Pages/AccountPage.dart';
import 'Pages/ProfilePage.dart';
import 'Pages/ForumPage.dart';
import 'Pages/Marketplace.dart';
import 'Pages/MagazinePage.dart';
import 'Pages/ComparisonPage.dart';
import 'Pages/HomePage.dart';
import 'Pages/AdminPanelPage.dart';
...
Future<void> _checkLoginStatus() async {
  ...
  final token = prefs.getString('token'); // Az AuthService _tokenKey = 'token' kulcsát használjuk
  print('CheckLoginStatus: Token read from SharedPreferences: $token'); // Debug naplózás
  if (mounted) {
    setState(() {
  ...
  if (_isLoggedIn) {
    print('User is logged in, fetching user role...');
